...
namespace gestao_produtos.api.Models
{
    ...
    public class ApiResponse
    {
        ...
        /// </summary>
        public IEnumerable<ApiError> Errors { get; private init; } = System.Array.Empty<ApiError>();
        ...
        private static ApiError[] CreateApiErrors(string errorMessage) => new ApiError[] { new ApiError(errorMessage) };
    }
}
